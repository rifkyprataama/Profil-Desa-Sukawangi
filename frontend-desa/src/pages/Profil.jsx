      ...
      {loading ? (
        <div className="max-w-[1200px] mx-auto px-6 py-20 w-full animate-pulse">
          ...
          <div className="space-y-4 mb-16">
            ...
            <div className="h-4 bg-[#e4e2de] w-full rounded"></div>
            <div className="h-4 bg-[#e4e2de] w-3/4 rounded"></div>
          </div>
        </div>
      ) : profilDesa ? (
        <>
            ...
            <div className="max-w-[1200px] mx-auto px-6">
              <div className="flex flex-col lg:flex-row gap-16 items-start">
                ...
                <div className="lg:w-7/12">
                  ...
                  >
                    {profilDesa.sejarah ? (
                      <div dangerouslySetInnerHTML={{ __html: profilDesa.sejarah }} />
                    ) : (
                      <>
                        <p>Desa Sukawangi berawal dari sebuah permukiman agraris kecil yang terletak di kaki pegunungan. Sejak awal berdirinya, masyarakat desa ini dikenal sangat memegang teguh nilai-nilai gotong royong dan kearifan lokal dalam mengelola sumber daya alam.</p>
                        <p>Seiring berjalannya waktu dan pergantian kepemimpinan, Desa Sukawangi terus berkembang menjadi desa yang mandiri. Pertanian dan perkebunan tetap menjadi urat nadi perekonomian, namun kini dipadukan dengan inovasi tata kelola pemerintahan berbasis digital yang transparan dan responsif.</p>
                      </>
                    )}
                  </div>
                </div>
                ...
                <div className="lg:w-5/12 w-full flex flex-col gap-6">
                  <div className="bg-[#1b4332] text-white p-8 rounded-2xl shadow-lg relative overflow-hidden">
                    ...
                    <div className="space-y-4 relative z-10">
                      <div className="flex justify-between border-b border-white/20 pb-3"><span className="text-white/70">Sebelah Utara</span><span className="font-bold">Desa Babakan</span></div>
                      <div className="flex justify-between border-b border-white/20 pb-3"><span className="text-white/70">Sebelah Selatan</span><span className="font-bold">Hutan Lindung / Perhutani</span></div>
                      <div className="flex justify-between border-b border-white/20 pb-3"><span className="text-white/70">Sebelah Timur</span><span className="font-bold">Desa Cikancana</span></div>
                      <div className="flex justify-between"><span className="text-white/70">Sebelah Barat</span><span className="font-bold">Kecamatan Gekbrong</span></div>
                    </div>
                  </div>
          ...
          <section id="demografi" className="py-20 bg-[#f5f3ef] scroll-mt-20">
            <div className="max-w-[1200px] mx-auto px-6">
              <div className="text-center mb-12">
                ...
                <p className="text-[16px] text-[#414844]">Gambaran umum kependudukan dan fasilitas penunjang di Desa Sukawangi.</p>
              </div>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                <div className="bg-white rounded-2xl p-8 border border-[#c1c8c2]/40 shadow-sm">
                  <div className="flex items-center gap-3 mb-8">
                    ...
                    <div><h3 className="text-[20px] font-bold text-[#012d1d]">Populasi Penduduk</h3><p className="text-[14px] text-[#717973]">Total: 5.200 Jiwa (Tahun 2026)</p></div>
                  </div>
                  <div className="space-y-6">
                    <div>
                      <div className="flex justify-between text-[14px] font-bold mb-2"><span className="text-[#003f63]">Laki-laki (52%)</span><span className="text-[#012d1d]">2.704 Jiwa</span></div>
                      <div className="w-full bg-[#efeeea] rounded-full h-3"><div className="bg-[#003f63] h-3 rounded-full" style={{ width: '52%' }}></div></div>
                    </div>
                    <div>
                      <div className="flex justify-between text-[14px] font-bold mb-2"><span className="text-[#835336]">Perempuan (48%)</span><span className="text-[#012d1d]">2.496 Jiwa</span></div>
                      <div className="w-full bg-[#efeeea] rounded-full h-3"><div className="bg-[#835336] h-3 rounded-full" style={{ width: '48%' }}></div></div>
                    </div>
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white rounded-2xl p-6 border border-[#c1c8c2]/40 shadow-sm flex items-start gap-4">
                    ...
                    <div><h4 className="text-[24px] font-bold text-[#012d1d]">4</h4><p className="text-[13px] font-semibold text-[#717973]">Gedung Sekolah</p></div>
                  </div>
                  <div className="bg-white rounded-2xl p-6 border border-[#c1c8c2]/40 shadow-sm flex items-start gap-4">
                    <div className="bg-[#cde5ff] p-3 rounded-xl text-[#003f63]"><HeartPulse className="w-6 h-6"/></div>
                    <div><h4 className="text-[24px] font-bold text-[#012d1d]">1</h4><p className="text-[13px] font-semibold text-[#717973]">Puskesmas / Pustu</p></div>
                  </div>
                  <div className="bg-white rounded-2xl p-6 border border-[#c1c8c2]/40 shadow-sm flex items-start gap-4">
                    <div className="bg-[#1b4332]/10 p-3 rounded-xl text-[#012d1d]"><Landmark className="w-6 h-6"/></div>
                    <div><h4 className="text-[24px] font-bold text-[#012d1d]">8</h4><p className="text-[13px] font-semibold text-[#717973]">Masjid / Mushola</p></div>
                  </div>
                  <div className="bg-white rounded-2xl p-6 border border-[#c1c8c2]/40 shadow-sm flex items-start gap-4">
                    <div className="bg-gray-100 p-3 rounded-xl text-gray-700"><Building2 className="w-6 h-6"/></div>
                    <div><h4 className="text-[24px] font-bold text-[#012d1d]">3</h4><p className="text-[13px] font-semibold text-[#717973]">Fasilitas Umum</p></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <section id="aparatur" className="py-20 bg-[#fbf9f5] scroll-mt-20">
            <div className="max-w-[1200px] mx-auto px-6">
              <div className="text-center mb-12">
                ...
                <p className="text-[16px] text-[#414844]">Ujung tombak pelayanan dan pembangunan Desa Sukawangi.</p>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-12">
                {[
                  { nama: profilDesa?.nama_kepala_desa || 'Ahmad Sunarya', jabatan: 'Kepala Desa' },
                  { nama: 'Budi Santoso, S.IP', jabatan: 'Sekretaris Desa' },
                  ...
                  <div key={idx} className="bg-white border border-[#c1c8c2]/40 rounded-2xl p-6 flex flex-col items-center text-center shadow-sm hover:shadow-lg transition-all duration-300 group cursor-pointer">
                    <div className="w-24 h-24 bg-[#e4e2de] rounded-full mb-5 overflow-hidden border-[3px] border-[#efeeea] group-hover:border-[#012d1d] transition-colors shadow-sm relative">
                      <img 
                        src={`https://ui-avatars.com/api/?name=${pejabat.nama.replace(/ /g, '+')}&background=012d1d&color=fff&size=150`} 
                        alt={pejabat.nama} 
                        loading="lazy"
          ...
          <section id="peta" className="py-20 bg-[#f5f3ef] scroll-mt-20 border-t border-[#c1c8c2]/40">
            <div className="max-w-[1200px] mx-auto px-6">
              <div className="flex flex-col md:flex-row items-center justify-between mb-10 gap-6">
                ...
                <div className="bg-white border border-[#c1c8c2]/50 px-6 py-3 rounded-lg flex items-center gap-3 shadow-sm">
                  <MapPin className="w-5 h-5 text-[#835336]" />
                  <span className="text-[15px] font-semibold text-[#012d1d]">Jl. Desa Sukawangi No. 1, Cianjur</span>
                </div>
              </div>
          ...
          <section className="py-16 bg-white border-t border-[#c1c8c2]/30">
            <div className="max-w-[1200px] mx-auto px-6 text-center flex flex-col items-center">
              ...
              <p className="text-[16px] text-[#414844] max-w-xl mb-8">Pemerintah Desa Sukawangi siap melayani pertanyaan dan pengaduan dari seluruh lapisan masyarakat.</p>
              <div className="flex flex-wrap justify-center gap-4">
                ...
                <Link to="/pengaduan" className="inline-flex items-center gap-2 bg-[#febe9b] text-[#331200] px-8 py-3 rounded-lg font-bold hover:bg-[#f8b895] transition-colors shadow-md">
