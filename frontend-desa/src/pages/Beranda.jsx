  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#fbf9f5] flex flex-col items-center justify-center">
        ...
        <p className="text-[#012d1d] font-bold animate-pulse">Memuat Data Desa...</p>
      </div>
    );
  }
      ...
      <section className="relative h-[85vh] min-h-[600px] w-full flex items-center justify-center mt-0">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto mt-10">
          ...
          <h1 className="text-[46px] md:text-[64px] font-extrabold text-white leading-tight drop-shadow-lg mb-6">
            {dataBeranda?.judul_banner || 'Website Resmi Desa Sukawangi'}
          </h1>
          
          <p className="text-[16px] md:text-[20px] text-white/90 leading-relaxed max-w-2xl mx-auto mb-10 font-medium">
            {dataBeranda?.subjudul_banner || 'Wadah layanan publik dan transparansi informasi untuk mewujudkan masyarakat Desa Sukawangi yang mandiri, sejahtera, dan berbudaya.'}
          </p>
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="bg-white rounded-3xl border border-[#c1c8c2]/40 shadow-sm overflow-hidden flex flex-col lg:flex-row">
            ...
            <div className="lg:w-2/5 relative min-h-[400px] bg-[#e4e2de]">
              <img 
                src={
                  dataProfil?.foto_kepala_desa 
                    ? `http://localhost:8000/storage/${dataProfil.foto_kepala_desa}`
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#012d1d] via-[#012d1d]/40 to-transparent flex flex-col justify-end p-8">
                ...
                <h3 className="text-[28px] font-bold text-white mb-1">
                  {dataProfil?.nama_kepala_desa || 'Ahmad Sunarya'}
                </h3>
            ...
            <div className="lg:w-3/5 p-8 md:p-12 flex flex-col justify-center">
              ...
              <p className="text-[16px] text-[#414844] leading-relaxed mb-10 italic border-l-4 border-[#835336] pl-6 bg-[#fbf9f5] py-4 pr-4 rounded-r-xl">
                "{dataProfil?.sambutan || 'Selamat datang di portal resmi Desa Sukawangi. Kami berkomitmen untuk terus berinovasi dalam memberikan pelayanan terbaik, transparan, dan akuntabel kepada seluruh warga masyarakat demi kemajuan desa yang kita cintai.'}"
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-[#012d1d] p-8 rounded-2xl shadow-lg relative overflow-hidden group">
                  ...
                  <p className="text-[15px] font-semibold text-white/90 leading-relaxed italic">
                    "{dataProfil?.visi || 'Terwujudnya Desa Sukawangi yang Mandiri, Sejahtera, Agamis, dan Berbudaya berbasis Pertanian dan Teknologi.'}"
                  </p>
                </div>
                ...
                <div className="bg-[#f5f3ef] border border-[#c1c8c2] p-8 rounded-2xl relative overflow-hidden">
                  ...
                  <div 
                    className="text-[14px] text-[#414844] space-y-2 font-medium [&>p]:mb-2 [&>ul]:list-disc [&>ul]:pl-4"
                    dangerouslySetInnerHTML={{ 
                      __html: dataProfil?.misi || `
                        <ul class="text-[14px] text-[#414844] space-y-3 font-medium">
                          <li class="flex items-start gap-2"><span class="text-[#835336] font-bold mt-0.5">•</span> Meningkatkan kualitas tata kelola pemerintahan yang bersih.</li>
                          <li class="flex items-start gap-2"><span class="text-[#835336] font-bold mt-0.5">•</span> Meningkatkan pembangunan infrastruktur desa.</li>
                          <li class="flex items-start gap-2"><span class="text-[#835336] font-bold mt-0.5">•</span> Pemberdayaan ekonomi kerakyatan & UMKM.</li>
                        </ul>
                      `
                    }}
                  />
        ...
        <div className="max-w-[1200px] mx-auto px-6 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="lg:col-span-1 bg-[#febe9b] rounded-3xl p-8 text-[#331200] flex flex-col justify-center shadow-2xl transform lg:-translate-y-6">
              ...
              <p className="text-[42px] font-black leading-tight mb-6">
                {dataBeranda?.realisasi_pendapatan || 'Rp 1.85 M'}
              </p>
              ...
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between text-[14px] font-bold mb-1">
                    ...
                    <span>{dataBeranda?.persentase_dd || 65}%</span>
                  </div>
                  <div className="w-full bg-black/10 rounded-full h-2">
                    <div className="bg-[#331200] h-2 rounded-full" style={{ width: `${dataBeranda?.persentase_dd || 65}%` }}></div>
                  </div>
                </div>
                <div>
                  <div className="flex justify-between text-[14px] font-bold mb-1">
                    <span>Alokasi Dana Desa (ADD)</span>
                    <span>{dataBeranda?.persentase_add || 25}%</span>
                  </div>
                  <div className="w-full bg-black/10 rounded-full h-2">
                    <div className="bg-[#331200] h-2 rounded-full" style={{ width: `${dataBeranda?.persentase_add || 25}%` }}></div>
                  </div>
                </div>
                <div>
                  <div className="flex justify-between text-[14px] font-bold mb-1">
                    <span>Pendapatan Asli Desa (PADes)</span>
                    <span>{dataBeranda?.persentase_pades || 10}%</span>
                  </div>
                  <div className="w-full bg-black/10 rounded-full h-2">
                    <div className="bg-[#331200] h-2 rounded-full" style={{ width: `${dataBeranda?.persentase_pades || 10}%` }}></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {dataBerita.length > 0 ? (
              dataBerita.map((berita) => (
                <Link to={`/berita/${berita.id}`} key={berita.id} className="group bg-white rounded-2xl overflow-hidden border border-[#c1c8c2]/40 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 flex flex-col">
                  <div className="h-56 overflow-hidden relative bg-[#e4e2de]">
                    <img 
                      src={
                        (berita.gambar || berita.thumbnail) 
                          ? `http://localhost:8000/storage/${berita.gambar || berita.thumbnail}` 
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    <span className="text-[#717973] text-[13px] font-bold mb-3">
              ...
              <div className="col-span-full text-center text-[#717973] py-10">
